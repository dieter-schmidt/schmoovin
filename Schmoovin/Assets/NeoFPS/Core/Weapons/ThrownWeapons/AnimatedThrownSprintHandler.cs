...
namespace NeoFPS
{
    ...
    [HelpURL("https://docs.neofps.com/manual/weaponsref-mb-animatedthrownsprinthandler.html")]
    public class AnimatedThrownSprintHandler : AnimatedSprintAnimationHandler
    {
