...
{
    [MotionGraphElement("Character/Ground Normal")]
    public class GroundNormalCondition : MotionGraphCondition
    {
        ...
        public override bool CheckCondition(MotionGraphConnectable connectable)
        {
            ...
            float groundSlopeAngle = Vector3.Angle(controller.characterController.groundNormal, controller.characterController.up);
            switch (m_Comparison)
            {
