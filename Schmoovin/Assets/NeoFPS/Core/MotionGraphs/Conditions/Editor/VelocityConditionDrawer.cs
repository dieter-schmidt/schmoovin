...
{
    [MotionGraphConditionDrawer(typeof(VelocityCondition))]
    [HelpURL("https://docs.neofps.com/manual/motiongraphref-mgc-velocitycondition.html")]
    public class VelocityConditionDrawer : MotionGraphConditionDrawer
    {
