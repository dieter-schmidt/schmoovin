...
{
    [MotionGraphConditionDrawer(typeof(IntCondition))]
    [HelpURL("http://docs.neofps.com/manual/motiongraphref-mgc-intcondition.html")]
    public class IntConditionDrawer : MotionGraphConditionDrawer
    {
