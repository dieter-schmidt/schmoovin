...
{
    [MotionGraphConditionDrawer(typeof(FloatCondition))]
    [HelpURL("http://docs.neofps.com/manual/motiongraphref-mgc-floatcondition.html")]
    public class FloatConditionDrawer : MotionGraphConditionDrawer
    {
        protected override void Inspect(Rect line1)
        {
            ...
            MotionGraphEditorGUI.ParameterDropdownField<FloatParameter>(r1, graphRoot, serializedObject.FindProperty("m_Property"));
