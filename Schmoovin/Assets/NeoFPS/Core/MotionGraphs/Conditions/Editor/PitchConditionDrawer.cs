...
{
    [MotionGraphConditionDrawer(typeof(PitchCondition))]
    [HelpURL("http://docs.neofps.com/manual/motiongraphref-mgc-pitchcondition.html")]
    public class PitchConditionDrawer : MotionGraphConditionDrawer
    {
