...
{
    [MotionGraphConditionDrawer(typeof(SwitchCondition))]
    [HelpURL("http://docs.neofps.com/manual/motiongraphref-mgc-switchcondition.html")]
    public class SwitchConditionDrawer : MotionGraphConditionDrawer
    {
        protected override void Inspect (Rect line1)
        {
            ...
            MotionGraphEditorGUI.ParameterDropdownField<SwitchParameter>(r1, graphRoot, serializedObject.FindProperty("m_Property"));
