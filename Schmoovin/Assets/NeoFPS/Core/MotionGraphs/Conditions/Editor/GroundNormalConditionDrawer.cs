...
{
    [MotionGraphConditionDrawer(typeof(GroundNormalCondition))]
    [HelpURL("http://docs.neofps.com/manual/motiongraphref-mgc-groundnormalcondition.html")]
    public class GroundNormalConditionDrawer : MotionGraphConditionDrawer
    {
