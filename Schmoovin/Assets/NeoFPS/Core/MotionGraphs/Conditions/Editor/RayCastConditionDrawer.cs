...
{
    [MotionGraphConditionDrawer(typeof(RayCastCondition))]
    [HelpURL("http://docs.neofps.com/manual/motiongraphref-mgc-raycastcondition.html")]
    public class RayCastConditionDrawer : MotionGraphConditionDrawer
    {
