...
{
    [MotionGraphConditionDrawer(typeof(CharacterHeightCondition))]
    [HelpURL("https://docs.neofps.com/manual/motiongraphref-mgc-characterheightcondition.html")]
    public class CharacterHeightConditionDrawer : MotionGraphConditionDrawer
    {
        protected override void Inspect(Rect line1)
        {
            ...
            EditorGUI.PropertyField(r1, serializedObject.FindProperty("m_HeightMode"), new GUIContent());
            ...
            EditorGUI.PropertyField(r3, serializedObject.FindProperty("m_CompareTo"), new GUIContent());
        }
