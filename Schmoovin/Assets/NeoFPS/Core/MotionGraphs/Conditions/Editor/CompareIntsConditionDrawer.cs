...
{
    [MotionGraphConditionDrawer(typeof(CompareIntsCondition))]
    [HelpURL("http://docs.neofps.com/manual/motiongraphref-mgc-compareintscondition.html")]
    public class CompareIntsConditionDrawer : MotionGraphConditionDrawer
    {
        protected override void Inspect (Rect line1)
        {
            ...
            MotionGraphEditorGUI.ParameterDropdownField<IntParameter>(r1, graphRoot, serializedObject.FindProperty("m_PropertyA"));
            ...
            MotionGraphEditorGUI.ParameterDropdownField<IntParameter>(r3, graphRoot, serializedObject.FindProperty("m_PropertyB"));
        }
