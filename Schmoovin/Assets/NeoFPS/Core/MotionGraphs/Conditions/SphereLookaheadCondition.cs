...
{
    [MotionGraphElement("Physics/Sphere Lookahead")]
    public class SphereLookaheadCondition : MotionGraphCondition
    {
        ...
        public override bool CheckCondition(MotionGraphConnectable connectable)
        {
            ...
            // Return cast result
            return controller.characterController.SphereCast(m_NormalisedHeight, castVector, space, m_LayerMask) == m_DoesHit;
        }
    }
}