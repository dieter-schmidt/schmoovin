...
{
    [MotionGraphElement("Dashes/Anim-Curve Directional Dash", "Dash (Anim Curve Directional)")]
    ...
    public class AnimCurveDirectionalDashState : MotionGraphState
    {
        ...
        [SerializeField, Tooltip("The pitch angle of the dash")]
        ...
        public override void OnEnter()
        {
            ...
            if (m_FrameOfReference == DashDirection.YawRelative)
            {
                ...
                ////add directional logic to curved dash state
                ...
                m_DashHeading = new Vector3(characterController.forward.x, 0.5f, characterController.forward.z).normalized;// characterController.forward;
                //add directional logic to curved dash state
                //m_DashHeading = Quaternion.AngleAxis(-45f, characterController.right) * m_DashHeading;
            ...
            Debug.Log(m_DashHeading);

            //m_MoveVelocity = Vector3.Project(m_EntryVelocity, m_DashHeading);
            m_MoveVelocity = 1f * m_DashHeading.normalized;
        ...
        public override void Update()
        {
            ...
            if (m_LerpIn < 1f)
            {
                ...
                m_DashVelocity = m_DashHeading * m_DashSpeed.value;
            }
            else
            {
