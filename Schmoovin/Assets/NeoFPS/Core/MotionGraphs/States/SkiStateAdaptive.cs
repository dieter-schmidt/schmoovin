...
{
    [MotionGraphElement("Ground Movement/SkiAdaptive", "SkiAdaptive")]
    [HelpURL("https://docs.neofps.com/manual/motiongraphref-mgs-skistate.html")]
    public class SkiStateAdaptive : MotionGraphState
    {
        ...
        public override void Update()
        {
            ...
            //apply accel in direction of player forward
            m_OutVelocity = Vector3.ProjectOnPlane(characterController.rawVelocity + (m_MoveDirection.value * -m_Deceleration.value * Time.deltaTime), characterController.groundSurfaceNormal);
            //float speed = m_OutVelocity.magnitude;
            float newSpeed = m_OutVelocity.magnitude;
