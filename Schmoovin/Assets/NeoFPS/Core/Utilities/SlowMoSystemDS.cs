...
namespace NeoFPS
{
    ...
    public class SlowMoSystemDS : MonoBehaviour, ISlowMoSystem, INeoSerializableComponent
    {
        [SerializeField, Tooltip("The (real, unscaled) time taken to transition time scales to and from default timescale")]
        private float m_TransitionDuration = 0.50f;
        [SerializeField, Tooltip("The (real, unscaled) time taken to transition time scales from fast to slow or vice versa")]
        private float m_LargeTransitionDuration = 0.50f;
